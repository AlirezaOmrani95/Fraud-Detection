...
def histogram(data, column, hist_bin, xlabel = 'values', ylabel = 'frequency'):
    '''
...
def box_plot(data, column, sorted_by, xlabel = None, ylabel = None):
    '''
    ...
    Parameters:
        ...
        xlabel (str): x_axis label, default value is None.
        ylabel (str): y_axis label, default value is None.
    ...
    plt.title(f'scatter plot of {sorted_by if xlabel == None else xlabel} vs {column if ylabel == None else ylabel}')
    plt.show()
...
def scatter_plot(data, x, y, xlabel = None, ylabel = None):
    ...
    plt.title(f'scatter plot {x if xlabel == None else xlabel} vs {y if ylabel == None else ylabel}')
    plt.show()
...
def line_plot(data, x, y, xlabel = None, ylabel = None):
    '''
...
def violet_plot(data, x, y, xlabel = None, ylabel = None):
    '''
...
def count_plot(data, x, xlabel = None):
    '''
...
def piechart(data, column, label = None):
    '''
    Plots the counts of observations in each categorical bin using bars.
    ...
    Parameters:
        ...
        label (str): label, default value is None.
