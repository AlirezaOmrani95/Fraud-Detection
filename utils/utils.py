...
def data_prep(
    address: str, mode: Optional[str] = None, random_state: int = 1
    ...
    - mode (Optional[str]): The method for oversampling.
    ...
    if mode == "smote":
        ...
        y_train_resampled = torch.tensor(
            y_train_resampled, dtype=torch.float32
        ).unsqueeze(1)
